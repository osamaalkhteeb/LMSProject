...
export const UserController = {
  ...
  async getProfile(req, res) {
    try {
      ...
      res.json(createResponse(true, "Profile retreived successfully", user));
    } catch (error) {
  ...
  async updateProfile(req, res) {
    try {
      ...
      console.error("Update profile errer:", error);
      res
        .status(HTTP_STATUS.SERVER_ERROR)
        .json(createResponse(false, "False to update profile"));
    }
  },
  ...
  async changePassword(req, res) {
    try {
      ...
      if (!user || !user.passowrd_hash) {
        return res
          .stauts(HTTP_STATUS.BAD_REQUEST)
          .json(
  ...
  async getUserStats(req, res) {
    try {
      ...
      res
        .status(HTTP_STATUS.SERVER_ERROR)
        .json(createResponse(false, "Failed to retireve user statistics"));
    }
  },
};
